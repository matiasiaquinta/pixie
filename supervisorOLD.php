...
include("php/conexion.php");
    ...
    if ($_SESSION['rol'] == null || $_SESSION['rol'] == '' || $_SESSION['rol'] == 'Administrador'){
    ...
    -->
         ...
         <div class="cards_one">
            ...
            <div class="middle">
               <div class="left">
                  ...
                  <h1><?php echo $fila_no['cantidad_no'];?></h1>
               </div>
               <div class="progress">
                  <svg>
         ...
         <div class="cards_two">
            ...
            <div class="middle">
               <div class="left">
                  ...
                  <h1><?php echo $fila_si['cantidad_si'];?></h1>
               </div>
               <div class="progress">
                  <svg>
                     <circle cx="38" cy="38" r="36"></circle>
      ...
      <div id="agregarEquipo">
         <div class="agregarEquipo_content">
            ...
            <!-- ------------------------------------------- -->
               <!-- ITEM 1 -->
               <div id="item1" class="agregarEquipo_function">
               ...
               <!-- ------------------------------------------- -->
               <!-- ITEM 1_CLIENTE -->
               <div id="item1_cliente" class="agregarEquipo_function">
                  ...
                  <div id="popupClienteNuevo">
                     ...
                     <div class="cliente_info">
                        <div class="valoresInput">
                           ...
                           <input class="inputShake" id="inputNombre" type="text" name="nombre" required >
                           <!-- msg error -->
                        ...
                        <div class="valoresInput">
                           ...
                           <input class="inputShake" id="inputApellido" type="text" name="apellido" required >
                           <!-- msg error -->
                        ...
                        <div class="valoresInput">
                           ...
                           <input class="inputShake" id="inputTelefono" type="text" name="telefono" required >
                           <!-- msg error -->
               ...
               <!-- ------------------------------------------- -->
               <!-- ITEM 2 -->
               <div id="item2" class="agregarEquipo_function">
               ...
               <!-- ------------------------------------------- -->
               <!-- ITEM 3 -->
               <div id="item3" class="agregarEquipo_function">              
               ...
               <div id="item4" class="agregarEquipo_function">
                  ...
                  <div class="empresaInformacion">
                       ...
                       <div class="valoresInput">
                           ...
                           <input class="inputShake" id="InputImei" type="text" name="imei" placeholder="Escriba el imei del equipo..." autocomplete="off" required > 
                           <!-- msg error -->                
                           <p class="error imei_error"></p>
                        </div>
                       <div class="valoresInput">
                           <label class="valoresLabel">Empresa</label>
                       ...
                       <div class="valoresInput">
                           ...
                           <input class="inputShake" id="InputClave" type="text" name="clave" autocomplete="off" required >
                           <!-- msg error -->                
                           <p class="error clave_error"></p>
                        </div>
                        <div class="valoresInput">
                           <label class="valoresLabel">Precio</label>
                           <input class="inputShake" id="InputPrecio" onkeyup="formatPrice(this)" type="text" name="precio" autocomplete="off" required >
                           <!-- msg error -->                
            ...
            <div class="editar_content">
               ...
               <div id="editarScroll" id="popupEditarTelefono">
                  ...
                  <div class="form-editar">
                      ...
                      <input type="text" name="empresaEditar" id="empresaEditar" autocomplete="off" >
                  </div>
            ...
            <ul class="slides-container" id="slides-container">
              ...
              <li class="slide">
                  <div class="infoEmpresa">
                     <h1><?php echo $resultEmpresa['nombre'] ?></h1>
                     <span>Ubicación: </span>
                     <span>Telefono: <?php echo $resultEmpresa['ubicacion'] ?></span>
                     <span>Pagina: <?php echo $resultEmpresa['telefono'] ?></span>
                     <span>Usuarios Registrados: <?php echo $count; ?></span>
      ...
      <div class="agregarEmpresa_content">
         ...
         <div class="datosNuevaEmpresa">
            ...
            <div class="valoresInput">
                ...
                <input class="inputShake" id="InputMailUsuario" type="text" name="mail" placeholder="Escriba el mail del usuario..." autocomplete="off" required>
                <input class="inputShake" id="nombreEmpresa" type="text" name="nombreEmpresa" autocomplete="off" readonly>
                <!-- msg error -->                
                    ...
                    <?php foreach ($dominioUsuarios as $domain => $usuariosPorDominio) { ?>
                        ...
                        <?php foreach ($usuariosPorDominio as $row) { ?>
                            <tr>
                                ...
                                <td><button class="btnUsuarioEditar" data-id="<?php echo $row['id']; ?>"><span class="material-symbols-sharp">edit_square</span></button></td>
                                <td><button class="btnUsuarioEliminar" onclick="confirmDelete(this);" data-id="<?php echo $row['id']; ?>" data-mail="<?php echo $row['email']; ?>"><span class="material-symbols-sharp">delete</span></button></td>
                            </tr>
                        <?php } ?>
                    <?php } ?>
                </tbody>
