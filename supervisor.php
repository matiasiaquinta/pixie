...
<head>
   ...
   <title>SUPERVISOR - Appletime</title>
            ...
            <div class="editar_content">
               ...
               <div id="editarScroll" id="popupEditarTelefono">
                  ...
                  <div class="form-editar">
                      ...
                      <input type="text" class="imei-input" name="imeiEditar" id="imeiEditar" oninput="validateNumber(this)" autocomplete="off" >
                  </div>
...
<!-- fin prueba -->
         ...
         <div class="editar_content">
            ...
            <h2>Editar Usuario:</h2>
               ...
               <div id="editarScrollUsuario">
                  ...
                  <div class="cerrarEditar">
                      <button type="submit" class="btn btn-primary" id ="btnGuardarCambiosUsuarios">Guardar cambios</button>
                  </div>
               </div>
         </div>
      </div>
   ...
   <main id="div4" class="sidebar_function saveLocalDiv" style="display: none;"> 
         ...
         <table id="tablaUsuarios02">
            ...
            ?>
               <tr>
                   ...
                   ?></td>
                   <td><button class="btnUsuarioEditar" onclick="agregarUsuario_function('editarUsuario02');" data-id="<?php echo $mostrar['id']; ?>"><span class="material-symbols-sharp">edit_square</span></td>
      ...
      <!-- editar usuario 
         <div id="editarUsuario" class="ModalEditar">
            <div class="editar_content">
               <button class="btnClose">&times;</button>
       
               <h2>Editar Usuario:</h2>
       
               <form id="formEditar" action="php/usuario_editar.php" method="POST">
               <input type="hidden" name="idEditarUsers" id="idEditarUsers" >

               <div id="editarScrollUsers">

                  <div class="form-editar">
                      <label for="">Nombre</label>
                      <input type="text" name="nombreUsers" id="nombreUsers">
                  </div>
            
                  <div class="form-editar">
                      <label for="">Mail</label>
                      <input type="text" name="mailUsers" id="mailUsers" autocomplete="off" >
                  </div>
                       
                  <div class="form-editar">
                      <label for="">Contraseña</label>
                      <input type="text" name="passwordUsers" id="passwordUsers" autocomplete="off" >
                  </div>

                  <div class="form-editar">
                      <label for="">Rol</label>
                      <select name="rolUsers" id="rolUsers">
