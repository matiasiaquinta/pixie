      ...
      <main id="div1" class="sidebar_function saveLocalDiv">
         ...
         <div class="left-top">
            ...
            <div class="agregarEquipo">
               <button id="btnAgregarEquipo" onclick="agregarEquipo_function('agregarEquipo')"><span
                     class="material-symbols-sharp">add</span></button>
            ...
            <div class="top">
               ...
               <div class="theme-toggler">
                  ...
                  <span class="material-symbols-sharp"
                     style="font-variation-settings:'FILL' 1,'wght' 300,'GRAD' 0,'opsz' 48">dark_mode</span>
               </div>
               <div class="profile">
                  <div class="info">
                     <p>Hola, <b style="text-transform: uppercase;">User</b></p>
    ...
    -->
            ...
            <div class="cards_one">
               ...
               <div class="middle">
                  <div class="left">
                     ...
                     <h1>
                        <?php echo $fila_no['equipos_pendientes']; ?>
                     </h1>
                  </div>
               </div>
            ...
            <div class="cards_two">
               ...
               <div class="middle">
                  <div class="left">
                     ...
                     <h1>
                        <?php echo $fila_si['para_entregar']; ?>
                     </h1>
                  </div>
                  <!--
               <div class="progress">
            ...
            <div class="cards_three">
               ...
               <div class="middle">
                  <div class="left">
                     ...
                     <h1>
                        <?php echo $fila_total['total_empresas']; ?>
                     </h1>
                  </div>
                  <!--
               <div class="progress">
               ...
               <div class="agregarContent">
                  ...
                  <div id="item1" class="agregarEquipo_function_noscroll">
                     ...
                     <div class="buttonsGeneral">
                        <div class="btnItem">
                           <button id="btnCliente" onclick="agregarEquipo_function('cliente')"><span
                                 class="material-symbols-sharp">person</span></button>
                           <span>Cliente</span>
                        </div>
                        <div class="btnItem">
                           <button id="btnEmpresa" onclick="agregarEquipo_function('empresa')"><span
                                 class="material-symbols-sharp">group</span></button>
                           <span>Empresa</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div id="item1_cliente" class="agregarEquipo_function_noscroll">
                     ...
                     <div id="popupBtnClientes">
                        ...
                        <div id="clienteExistente">
                           <input class="inputSearch" value="" type="text" name="searchClient" id="searchClient"
                        ...
                        <div class="btnItem">
                           <button onclick="agregarEquipo_function('cliente_existente')"><span
                                 class="material-symbols-sharp">arrow_forward_ios</span></button>
                           <span>Siguiente</span>
                        </div>

                        <h3>Si no esta creado el cliente, crea un cliente nuevo:</h3>
                        <div class="btnItem">
                           <button id="btnClienteNuevo" onclick="agregarEquipo_function('clienteNuevo')"><span
                                 class="material-symbols-sharp">person_add</span></button>
                           <span>Nuevo</span>
                        </div>
                     </div>
                     ...
                     <div id="popupClienteNuevo">
                        ...
                        <div class="cliente_info">
                           <div class="valoresInput">
                              ...
                              <input class="inputShake" id="inputNombre" type="text" name="nombre"
                           ...
                           <div class="valoresInput">
                              ...
                              <input class="inputShake" id="inputApellido" type="text" name="apellido"
                           ...
                           <div class="valoresInput">
                              ...
                              <input class="inputShake" id="inputTelefono" type="text" name="telefono"
                                 placeholder="Escriba el telefono del cliente..." required>
                              <!-- msg error -->
                        ...
                        <div class="btnItem">
                           <button onclick="agregarEquipo_function('cliente_nuevo')"><span
                                 class="material-symbols-sharp">arrow_forward_ios</span></button>
                        </div>
                     </div>
                  </div>
                  ...
                  <div id="item2" class="agregarEquipo_function_noscroll">
                     ...
                     <div class="buttonsGeneral">
                        <div class="btnItem">
                           <button id="btnTelefono" onclick="agregarEquipo_function('telefono')"><span
                                 class="material-symbols-sharp">phone_iphone</span></button>
                           <span>iPhone</span>
                        </div>
                        <div class="btnItem">
                           <button id="btnTablet" onclick="agregarEquipo_function('tablet')"><span
                                 class="material-symbols-sharp">tablet_mac</span></button>
                           <span>iPad</span>
                        </div>
                        <div class="btnItem">
                           <button id="btnNotebook" onclick="agregarEquipo_function('notebook')"><span
                                 class="material-symbols-sharp">computer</span></button>
                           <span>Macbook</span>
                        </div>
                        <div class="btnItem">
                           <button id="btnReloj" onclick="agregarEquipo_function('reloj')"><span
                                 class="material-symbols-sharp">watch</span></button>
                           <span>iWatch</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div id="item3" class="agregarEquipo_function_noscroll">
                     ...
                     <div class="btnItem">
                        <button id="btnModeloColor" onclick="agregarEquipo_function('nextTo4')"><span
                              class="material-symbols-sharp">arrow_forward_ios</span></button>
                     </div>
                  </div>
                  ...
                  <div id="item4" class="agregarEquipo_function">
                     ...
                     <div class="empresaInformacion">
                        <div class="valoresInput">
                           ...
                           <input class="inputNoshake" type="date" name="fecha" id="fechaAutomaticaEmpresa"
                        ...
                        <div class="valoresInput">
                           ...
                           <input class="inputShake" id="InputImei" type="text" name="imei"
                              oninput="validateNumber(this)" placeholder="Escriba el imei del equipo..."
                              autocomplete="off" required>
                           <!-- msg error -->
                        ...
                        <div class="valoresInput">
                           ...
                           <input class="inputShake" id="InputEmpresa" type="text" name="empresa"
                              placeholder="Escriba la empresa..." autocomplete="off" required>
                           <!-- select empresas -->
                        ...
                        <div class="valoresInput">
                           ...
                           <input class="inputShake" id="InputDetalles" type="text" name="detalles"
                              placeholder="Escriba los detalles del equipo..." autocomplete="off" required>
                           <!-- msg error -->
                                 ...
                                 if (mysqli_num_rows($resultPerifericos) > 0) {
                                    foreach ($resultPerifericos as $row) {
                                       ...
                                       <label class="checkbox-label">
                                          <input type="checkbox" name="perifericos[]"
                                             value="<?php echo $row['periferico']; ?>">
                        ...
                        <div class="valoresInput">
                           ...
                           <input class="inputShake" id="InputClave" type="text" name="clave"
                              placeholder="Escriba la clave del equipo..." autocomplete="off" required>
                           <!-- msg error -->
                           <p class="error clave_error"></p>
                        </div>
                        <div class="valoresInput">
                           <label class="valoresLabel">Precio</label>
                           <input class="inputShake" id="InputPrecio" onkeyup="formatPrice(this)"
                              oninput="validateNumber(this)" placeholder="Escriba el precio de la reparación..."
                              type="text" name="precio" autocomplete="off" required>
                           <!-- msg error -->
                        ...
                        <div class="btnItem" style="margin:0 auto;">
                           <button onclick="agregarEquipo_function('nextTo5')"><span
                                 class="material-symbols-sharp">arrow_forward_ios</span></button>
                        </div>
                     </div>
                  ...
                  <div id="item5" class="agregarEquipo_function">
                     ...
                     <div class="buttonsGeneral">
                        <div class="btnItem">
                           <button onclick="agregarEquipo_function('imprimir')"><span
                                 class="material-symbols-sharp">print</span></button>
                           <span>Imprimir</span>
                        </div>
                        <div class="btnItem">
                           <button onclick="agregarEquipo_function('mail')"><span
                                 class="material-symbols-sharp">mail</span></button>
                           <span>Mail</span>
                        </div>
                     </div>
            ...
            <table>
               ...
               <tbody id="table-body">
                  ...
                  while ($mostrar = mysqli_fetch_array($result)) {
                     ?>
                     <tr>
                        <td data-label="Fecha"><?php echo $mostrar['fecha'] ?></td>
                        <td data-label="Equipo"><?php echo $mostrar['equipo'] ?></td>
                        <td data-label="IMEI"><?php echo $mostrar['imei'] ?></td>
                        <td data-label="Empresa / Cliente"><?php echo $mostrar['empresa'] ?></td>
                        <td data-label="Falla"><?php echo $mostrar['falla'] ?></td>
                        ...
                        <td data-label="Clave"><?php echo $mostrar['clave'] ?></td>
                        <td style="display: none;"><?php echo $mostrar['precio'] ?></td>
                        <td style="display: none;"><?php echo $mostrar['terminado'] ?></td>
                        <td data-label="Para Entregar?"><?php echo $mostrar['paraEntregar'] ?></td>
                        <td data-label="Mas"><button class="btnOpenDetalles" data-id="<?php echo $mostrar['id']; ?>"><span
                                 class="material-symbols-sharp">add</span></button></td>
                        <td data-label="Editar"><button class="btnOpenEditar" data-id="<?php echo $mostrar['id']; ?>"><span
                                 class="material-symbols-sharp">edit_square</span></button></td>
                        <td data-label="Eliminar"><button class="btnEliminar" onclick="confirmDeleteEquipo(this);"
                              data-id="<?php echo $mostrar['id']; ?>" data-equipo="<?php echo $mostrar['equipo']; ?>"
                              data-empresa="<?php echo $mostrar['empresa']; ?>"><span
                                 class="material-symbols-sharp">delete</span></button></td>
                     </tr>
                  <?php } ?>
               </tbody>
            </table>
            ...
            <form id="formEditar" action="php/equipo_editar.php" method="POST">
               ...
               <div id="editarScroll" id="popupEditarTelefono">
                  ...
                  <div class="form-editar">
                     ...
                     <input type="text" name="precioEditar" id="precioEditar" onkeyup="formatPrice(this)"
                        autocomplete="off">
                  </div>
                  ...
                  <div class="terminado-editar">
                     <div class="uno">
                        ...
                        <div class="valoresTerminado">
                           <input class="terminadoInput" type="radio" name="terminadoEditar" value="si"
                              id="terminadoSi">
                           <label class="terminadoLabel" for="terminadoSi">SI</label>
                           <input class="terminadoInput" type="radio" name="terminadoEditar" value="no"
                              id="terminadoNo">
                     ...
                     <div class="uno">
                        ...
                        <div class="valoresTerminado">
                           <input class="terminadoInput" type="radio" name="paraEntregarEditar" value="si"
                              id="paraEntregarSi">
                           <label class="terminadoLabel" for="paraEntregarSi">SI</label>
                           <input class="terminadoInput" type="radio" name="paraEntregarEditar" value="no"
                              id="paraEntregarNo">
      ...
      <div id="masDetalles" class="ModalDetalles">
         <div class="modal-content_detalles">
            ...
            <div class="spanTitle">
               Mas detalles del equipo: <span id="name_equipo"></span><span id="name_cliente">, del cliente: </span>
               <span id="name_empresa">de la empresa: </span>
            </div>

            <button class="btnClose"
               style="background-color:#41f1b6;color:black;padding:5px 10px 5px 10px;">&times;</button>
      ...
      <main id="div3" class="sidebar_function saveLocalDiv" style="display: none;">
         ...
         <div class="divTop">
            ...
            <div class="divLeft">
               ...
               <div class="agregarEquipo">
                  <button id="btnAgregarEmpresa" onclick="agregarEmpresa_function('empresa')"><span
                        class="material-symbols-sharp">add</span></button>
                        ...
                        <li class="slide" data-empresa="<?php echo $resultEmpresa['nombre'] ?>">
                           <div class="infoEmpresa">
                              <div class="infoDetalle">
                                 ...
                                 <div>
                                    <h3>Ubicación: </h3><span
                                       data-info="ubicacion"><?php echo $resultEmpresa['ubicacion'] ?></span>
                                 </div>
                                 <div>
                                    <h3>Telefono: </h3><span
                                       data-info="telefono"><?php echo $resultEmpresa['telefono'] ?></span>
                                 </div>
                                 <div>
                                 ...
                                 <span class="totalEmpresa">Total Empresas:
                                    <?php echo $position; ?>/<?php echo $totalEmpresas; ?></span>

                                 <button class="btnEditar" data-id="<?php echo $resultEmpresa['id']; ?>">Editar
                                    Empresa</button>
                                 <div class="space"></div>
                                 <button class="btnDominio" data-domain="<?php echo $domain; ?>"><span
                                       class="material-symbols-sharp">keyboard_double_arrow_down</span></button>
                              </div>
                           </div>
         ...
         <div id="agregarEmpresa">
            <div class="agregarEmpresa_content">
               ...
               <div class="datosNuevaEmpresa">
                  <div class="valoresInput">
                     <label class="valoresLabel">Nombre</label>
                     <input class="inputShake" id="InputNombreEmpresa" type="text" name="nombre"
                        placeholder="Escriba el nombre de la empresa..." autocomplete="off" required>
                     <!-- msg error -->
                     <p class="error nombre_error"></p>
                  </div>
                  <div class="valoresInput">
                     <label class="valoresLabel">Mail <span style="font-size: 0.6em;">(@empresa.com, ejemplo:
                           @appletime.com)</span> </label>
                     <input class="inputShake" id="InputMailEmpresa" type="text" name="mail"
                        placeholder="Escriba el mail de la empresa..." autocomplete="off" required>
                     <!-- msg error -->
                     <p class="error mail_error"></p>
                  </div>
                  <div class="valoresInput">
                     <label class="valoresLabel">Ubicación</label>
                     <input class="inputShake" id="InputUbicacionEmpresa" type="text" name="ubicacion"
                        placeholder="Escriba la ubicacion de la empresa..." autocomplete="off" required>
                     <!-- msg error -->
                     <p class="error ubicacion_error"></p>
                  </div>
                  <div class="valoresInput">
                     <label class="valoresLabel">Telefono</label>
                     <input class="inputShake" id="InputTelefonoEmpresa" type="text" name="telefono"
                        placeholder="Escriba el telefono de la empresa..." autocomplete="off" required>
                     <!-- msg error -->
                     <p class="error telefono_error"></p>
                  </div>
                  <div class="valoresInput">
                     <label class="valoresLabel">Página</label>
                     <input class="inputShake" id="InputPaginaEmpresa" type="text" name="pagina"
                        placeholder="Escriba la pagina de la empresa..." autocomplete="off" required>
                     <!-- msg error -->
                     <p class="error pagina_error"></p>
                  </div>

                  <div class="btnItem" style="margin:0 auto;">
                     <button onclick="agregarEmpresa_function('empresaOk')"><span
                           class="material-symbols-sharp">arrow_forward_ios</span></button>
                  </div>
         ...
         <div id="agregarUsuario">
            <div class="agregarEmpresa_content">
               ...
               <div class="datosNuevaEmpresa">
                  <div class="valoresInput">
                     <label class="valoresLabel">Nombre</label>
                     <input class="inputShake" id="InputNombreUsuario" type="text" name="nombre"
                        placeholder="Escriba el nombre del usuario..." autocomplete="off" required>
                     <!-- msg error -->
                     <p class="error Unombre_error"></p>
                  </div>
                  <div class="valoresInput">
                     <label class="valoresLabel">Mail</label>
                     <input class="textEmpresa" id="InputMailUsuario" type="text" name="mail"
                        placeholder="Escriba el mail del usuario..." autocomplete="off" required>
                     <input class="nombreEmpresa" id="nombreEmpresa" type="text" name="nombreEmpresa" autocomplete="off"
                        readonly>
                     <!-- msg error -->
                  ...
                  <div class="valoresInput">
                     ...
                     <input class="inputShake" id="InputPasswordUsuario" type="text" name="password"
                        placeholder="Escriba la contraseña del usuario..." autocomplete="off" required>
                     <!-- msg error -->
                     <p class="error Upassword_error"></p>
                  </div>

                  <div class="btnItem" style="margin:0 auto;">
                     <button onclick="agregarEmpresa_function('usuarioOk')"><span
                           class="material-symbols-sharp">arrow_forward_ios</span></button>
                  </div>
         ...
         <div class="usuariosTable">
            <div class="divLeftUsuariosTable">
               ...
               <div class="agregarUsuario">
                  <button id="btnAgregarUsuario" onclick="agregarEmpresa_function('usuario')"><span
                        class="material-symbols-sharp">add</span></button>
                     ...
                     <?php foreach ($dominioUsuarios as $domain => $usuariosPorDominio) { ?>
                        ...
                        <?php foreach ($usuariosPorDominio as $row) { ?>
                           <tr>
                              ...
                              <td><button class="btnOpenEditarUsuario" data-id="<?php echo $row['id']; ?>"><span
                                       class="material-symbols-sharp">edit_square</span></button></td>
                              <td><button class="btnUsuarioEliminar"
                                    onclick="confirmDelete(this, '¿Estás seguro de querer eliminar a este usuario?', 'php/usuario_eliminar.php');"
                                    data-id="<?php echo $row['id']; ?>" data-mail="<?php echo $row['email']; ?>"><span
                                       class="material-symbols-sharp">delete</span></td>
                           </tr>
                        <?php } ?>
                     <?php } ?>
                  </tbody>
                  ...
                  <?php foreach ($dominioEquipos as $domain => $equiposPorDominio) { ?>
                     ...
                     <?php foreach ($equiposPorDominio as $equipo) { ?>
                        <tr>
                           ...
                           <td><button class="btnOpenDetalles" data-id="<?php echo $equipo['id']; ?>"><span
                                    class="material-symbols-sharp">add</span></button></td>
                           <td><button class="btnOpenEditar" data-id="<?php echo $equipo['id']; ?>"><span
                                    class="material-symbols-sharp">edit_square</span></button></td>
                        </tr>
                     <?php }
                  } ?>
      ...
      <main id="div4" class="sidebar_function saveLocalDiv" style="display: none;">
         ...
         <div class="divLeftUsuario">
            ...
            <div class="agregarEquipo">
               <button id="btnAgregarUsuario02" onclick="agregarUsuario_function('usuario')"><span
                     class="material-symbols-sharp">add</span></button>
                  ...
                  while ($mostrar = mysqli_fetch_array($result)) {
                     ...
                     <tr>
                        ...
                        <td class="centered-cell">
                           <span id="password_<?php echo $mostrar['id']; ?>"
                              style="display: none;"><?php echo $mostrar['password'] ?></span>
                           <span class="maskedPassword"
                              id="maskedPassword_<?php echo $mostrar['id']; ?>"><?php echo str_repeat('*', strlen($mostrar['password'])); ?></span>
                           <button class="btnShowHide" onmousedown="showPassword(<?php echo $mostrar['id']; ?>)"
                        ...
                        ?></td>
                        <td><button class="btnOpenEditarUsuarios" data-id="<?php echo $mostrar['id']; ?>"><span
                                 class="material-symbols-sharp">edit_square</span></button></td>
                        <td><button class="btnEliminar" onclick="confirmDeleteUsers(this);"
                              data-id="<?php echo $mostrar['id']; ?>" data-mail="<?php echo $mostrar['email']; ?>"><span
                                 class="material-symbols-sharp">delete</span></button></td>
                     </tr>
                  <?php } ?>
               </tbody>
         ...
         <div id="agregarUsuario02">
            <div class="agregarEmpresa_content">
               ...
               <div class="datosNuevaEmpresa">
                  <div class="valoresInput">
                     <label class="valoresLabel">Nombre</label>
                     <input class="inputShake" id="InputAgregarNombre" type="text" name="nombre"
                        placeholder="Escriba el nombre del usuario..." autocomplete="off" required>
                     <!-- msg error -->
                  ...
                  <div class="valoresInput">
                     <label class="valoresLabel">Mail</label>
                     <input class="inputShake" id="InputAgregarMail" type="text" name="mail"
                        placeholder="Escriba el mail del usuario..." autocomplete="off" required>
                     <!-- msg error -->
                  ...
                  <div class="valoresInput">
                     <label class="valoresLabel">Contraseña</label>
                     <input class="inputShake" id="InputAgregarPassword" type="text" name="password"
                        placeholder="Escriba la contraseña del usuario..." autocomplete="off" required>
                     <!-- msg error -->
                  ...
                  <div class="btnItem" style="margin:0 auto;">
                     <button onclick="agregarUsuario_function('usuarioOk')"><span
                           class="material-symbols-sharp">arrow_forward_ios</span></button>
                  </div>
